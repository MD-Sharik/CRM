    ...
    <div>
      <main className="flex flex-col items-center justify-center pt-32">
          ...
          <div className="px-3 w-full lg:w-2/5">
            <div className="mx-auto mb-8 max-w-lg text-center lg:mx-0 lg:max-w-md lg:text-left">
              ...
              <p className="visible mx-0 mt-3 mb-0 text-sm leading-relaxed text-left text-slate-400">
                Helping you maximize the chance of loan approval.
              </p>
            </div>
        ...
        <section className="p-20 space-y-8">
          <h1 className="text-4xl text-center my-20">WHO WE ARE?</h1>
          <p>
            First India Credit Pvt Ltd. is a digital finance company working
            with the country’s top banks and NBFCs to provide Credit Cards,
            Personal Loans, Business Loans, Home Loans, Loans Against Property,
            Balance Transfers, Loan Top-ups, and Overdraft facilities in a quick
            and easy way. We assist with your financial needs by offering a
            variety of loans and credit cards. With partnerships exceeding 30
            banks and NBFCs, our process involves collecting all your documents
            first and then submitting your application to the most suitable
            bank, increasing your chances of securing the loan you need.
          </p>
        </section>
      </main>
    </div>
